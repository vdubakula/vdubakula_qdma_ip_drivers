...
#===============================================================================
#
#          FILE: test_pf_vf_mix_advance1.sh
# 
#         USAGE: ./test_pf_vf_mix_advance1.sh <1/2/3>
# 
...
for m_pf in ${master_pfs[@]}; do
	...
	echo ""
	echo "***** master_pf=$m_pf All 0 test *****"
	remove_drv
	insert_drv $m_pf
	...
	echo 0 >  /sys/bus/pci/devices/$dev_base.0/qdma/qmax
	echo 0 >  /sys/bus/pci/devices/$dev_base.1/qdma/qmax
	echo 0 >  /sys/bus/pci/devices/$dev_base.2/qdma/qmax
	echo 0 >  /sys/bus/pci/devices/$dev_base.3/qdma/qmax
	...
	#Instanciate VFs
	echo 0 > /sys/bus/pci/devices/$dev_base.0/sriov_numvfs
	echo 0 > /sys/bus/pci/devices/$dev_base.1/sriov_numvfs
	echo 0 > /sys/bus/pci/devices/$dev_base.2/sriov_numvfs
	echo 0 > /sys/bus/pci/devices/$dev_base.3/sriov_numvfs
	...
	echo "qdma_test"
	qdma_test > MPF$m_pf.allZero.log
	if [ $? -ne 0 ]; then
		exit 1
	fi
