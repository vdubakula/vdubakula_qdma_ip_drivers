...
int eqdma_c2h_notify_empty_info_dump(
		uint32_t reg_val, char *buf, uint32_t buf_len);
#define EQDMA_C2H_NOTIFY_EMPTY_ADDR                        0x1800
...
int eqdma_c2h_stat_s_axis_c2h_accepted_1_info_dump(
		uint32_t reg_val, char *buf, uint32_t buf_len);
#define EQDMA_C2H_STAT_S_AXIS_C2H_ACCEPTED_1_ADDR          0x1804
...
int eqdma_c2h_stat_s_axis_wrb_accepted_1_info_dump(
		uint32_t reg_val, char *buf, uint32_t buf_len);
#define EQDMA_C2H_STAT_S_AXIS_WRB_ACCEPTED_1_ADDR          0x1808
...
int eqdma_c2h_stat_desc_rsp_pkt_accepted_1_info_dump(
		uint32_t reg_val, char *buf, uint32_t buf_len);
#define EQDMA_C2H_STAT_DESC_RSP_PKT_ACCEPTED_1_ADDR        0x180C
...
int eqdma_c2h_stat_axis_pkg_cmp_1_info_dump(
		uint32_t reg_val, char *buf, uint32_t buf_len);
#define EQDMA_C2H_STAT_AXIS_PKG_CMP_1_ADDR                 0x1900
...
int eqdma_c2h_stat_s_axis_wrb_accepted_2_info_dump(
		uint32_t reg_val, char *buf, uint32_t buf_len);
#define EQDMA_C2H_STAT_S_AXIS_WRB_ACCEPTED_2_ADDR          0x1908
...
int eqdma_c2h_st_pld_fifo_depth_info_dump(
		uint32_t reg_val, char *buf, uint32_t buf_len);
#define EQDMA_C2H_ST_PLD_FIFO_DEPTH_ADDR                   0x190C
...
int eqdma_func_status_reg_info_dump(
		uint32_t reg_val, char *buf, uint32_t buf_len);
#define EQDMA_FUNC_STATUS_REG_ADDR                         0x2400
...
int eqdma_func_cmd_reg_info_dump(
		uint32_t reg_val, char *buf, uint32_t buf_len);
#define EQDMA_FUNC_CMD_REG_ADDR                            0x2404
...
int eqdma_func_interrupt_vector_reg_info_dump(
		uint32_t reg_val, char *buf, uint32_t buf_len);
#define EQDMA_FUNC_INTERRUPT_VECTOR_REG_ADDR               0x2408
...
int eqdma_target_func_reg_info_dump(
		uint32_t reg_val, char *buf, uint32_t buf_len);
#define EQDMA_TARGET_FUNC_REG_ADDR                         0x240C
...
int eqdma_func_interrupt_ctl_reg_info_dump(
		uint32_t reg_val, char *buf, uint32_t buf_len);
#define EQDMA_FUNC_INTERRUPT_CTL_REG_ADDR                  0x2410
...
#define CMPL_CTXT_DATA_W1_BADDR4_HIGH_L_MASK              GENMASK(31, 6)
#define CMPL_CTXT_DATA_W1_RSVD_2_MASK                     GENMASK(5, 0)
