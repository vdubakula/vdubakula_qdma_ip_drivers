...
try:
    for vm_id in range(1, nb_vms + 1):
        ...
        cmd = "./vm_stress_test_top.sh " + str(dpdk_bind_drv) +" " + str(vm_num_vfs[vm_id-1]) + " " + str(total_queues) + " " + str(time_per_vm) + " > stress_vm_log.txt"
        print cmd
        ...
        os.system("sshpass -p dpdk scp -r -P " + str(base_port + vm_id) + " root@127.0.0.1:/home/dpdk/dpdk-stable-20.11/examples/qdma_testapp/stress_vm_log.txt ./vm" + str(vm_id) + "_logs/")        
